  ...
  return (
    <>
      <NextSeo
        ...
        description="By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Flare if you do not agree to
      ...
      <div className="h-full py-12">
        <Container>
          <div className="prose dark:prose-invert">
            ...
            <p>
              We employ the use of cookies. By accessing Flare, you agreed to
              use cookies in agreement with the Flare&apos;s Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, Flare and/or its licensors own the
              intellectual property rights for all material on Flare. All
              intellectual property rights are reserved. You may access this
              from Flare for your own personal use subjected to restrictions set
              in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Flare</li>
              <li>Sell, rent or sub-license material from Flare</li>
              <li>Reproduce, duplicate or copy material from Flare</li>
              <li>Redistribute content from Flare</li>
            </ul>
            ...
            <p>
              ...
              Flare does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of Flare,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, Flare
            ...
            <p>
              Flare reserves the right to monitor all Comments and to remove any
            ...
            <p>
              You hereby grant Flare a non-exclusive license to use, reproduce,
            ...
            <p>
              ...
              Flare; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Flare. Please include your name, your
